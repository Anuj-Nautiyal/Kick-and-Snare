          ...
          <div className='drum-machine-card flex flex-col items-center justify-center gap-15  w-[95%] sm:w-[80%] md:w-[70%] lg:w-[50%] h-[90%] md:h-[80%]'>
            ...
            <div className='grid grid-cols-3 w-[95%] md:w-[80%] h-[60%] gap-2'>
              <div className="first flex flex-col justify-center md:justify-between h-full">
                <Drumpad beat="Tom-1" pressedKey="7" audiosrc="/sounds/tom-1.mp3" />
                <Drumpad beat="O-Hihat" pressedKey="4" audiosrc="/sounds/O-hihat.mp3" />
                <Drumpad beat="C-Hihat" pressedKey="1" audiosrc="/sounds/C-hihat.mp3" />
              </div>
              <div className="second flex flex-col justify-center md:justify-between h-full">
                <Drumpad beat="C-Cymbal" pressedKey="8" audiosrc="/sounds/C-cymbal.mp3" />
                <Drumpad beat="Snare" pressedKey="5" audiosrc="/sounds/snare.mp3" />
                <Drumpad beat="Kick" pressedKey="2" audiosrc="/sounds/kick.mp3" />
              </div>
              <div className="third flex flex-col justify-center md:justify-between h-full">
                <Drumpad beat="Tom-2" pressedKey="9" audiosrc="/sounds/tom-2.mp3" />
                <Drumpad beat="R-cymbal" pressedKey="6" audiosrc="/sounds/R-cymbal.mp3" />
                <Drumpad beat="Floortom" pressedKey="3" audiosrc="/sounds/floortom.mp3" />
              </div>
            </div>
          </div>
        </section>
